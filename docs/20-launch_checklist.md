...
For an agent workflow, consume the requirements, decisions, and evidence already recorded in the run. Use the questions below to identify changes or gaps rather than restarting discovery. The [verification procedure](../skills/engineering-verification/SKILL.md) produces a current readiness report; release authorization remains separate.
