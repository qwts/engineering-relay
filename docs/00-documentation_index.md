# Engineering Relay - Documentation Index

This directory contains 23 guides: 22 covering the Software Development Life Cycle (SDLC), from initial planning through decommissioning, plus the documentation style guide. Documents are organized chronologically and grouped by SDLC phases.

For agent execution, use the [workflow guide](../workflow/guide.md) and [coordinator skill](../skills/engineering-workflow/SKILL.md). The reading order below is a reference sequence; the executable workflow selects applicable work based on the change and records evidence in a persistent run.
...
- [Documentation Style Guide](23-documentation_style_guide.md) — Shared formatting and writing guidance across all phases.
...
To contribute to Engineering Relay:
